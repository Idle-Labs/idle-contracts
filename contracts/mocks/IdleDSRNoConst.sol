...
import "./PotLikeMock.sol";

contract IdleDSRNoConst is ILendingProtocol, Ownable, DSMath {
  ...
  address public potAddress = address(0x197E90f9FAD81970bA7976f33CbD77088E5D7cf7);
  PotLike public pot = PotLike(potAddress);
   ...
   * @param _potAddress : idleToken address
   */
   function setPotLike(address _potAddress)
     external onlyOwner {
       require(_potAddress != address(0), "potAddress addr is 0");
       potAddress = _potAddress;
       pot = PotLikeMock(potAddress);
   }
