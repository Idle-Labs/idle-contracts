...
const IdleFulcrumDisabled = artifacts.require('IdleFulcrumDisabled');
const iDAIMock = artifacts.require('iDAIMock');
const DAIMock = artifacts.require('DAIMock');
const BNify = n => new BN(String(n));

contract('IdleFulcrumDisabled', function ([_, creator, nonOwner, someone, foo]) {
  beforeEach(async function () {
    ...
    this.iDAIWrapper = await IdleFulcrumDisabled.new(
