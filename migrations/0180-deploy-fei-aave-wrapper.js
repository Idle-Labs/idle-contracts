...
module.exports = async function(deployer, network, accounts) {
  ...
  const aaveV2WrapperAddress = await deployAaveV2WrapperProxy(proxyFactory, addresses.idleAaveV2Implementation, addresses.aFEI[network],
    addresses.aaveAddressesProvider[network], idleTokenAddress, creator);
