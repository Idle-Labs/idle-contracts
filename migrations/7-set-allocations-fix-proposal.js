...
module.exports = async (deployer, network, accounts) => {
  ...
  await deployer.deploy(IdleTokenV3_1);
  const newImplementation = await IdleTokenV3_1.deployed();
  ...
  const propName = '#Update setAllocations implementation to allow more wrappers';
  const proposal = {
