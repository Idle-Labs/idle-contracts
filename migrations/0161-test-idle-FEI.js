...
module.exports = async function(deployer, network, accounts) {
  ...
  const whale = "0xde6ab16a4015c680daab58021815d09ddb57db8e";
  ...
  await setAllocationsAndRebalance([toBN("50000"), toBN("50000")]);
  await log();

  await redeem(account1, "100");
  await redeem(account2, "100");
  await log();
};
