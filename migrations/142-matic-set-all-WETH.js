...
module.exports = async function(deployer, network, accounts) {
  ...
  // // setOracleAddress
  // console.log("calling setOracleAddress...", addresses.priceOracleV2[network]);
  ...
  // const aWETHV2Wrapper = await idleToken.protocolWrappers(addresses.aWETH[network]);
  // console.log("calling setAllAvailableTokensAndWrappers...");
  // console.log("aWETHV2Wrapper:", aWETHV2Wrapper)
  // await idleToken.setAllAvailableTokensAndWrappers(
  //   [addresses.aWETH[network]], // protocolTokens
  //   [aWETHV2Wrapper], // wrappers
  ...
  // await idleToken.setAToken(addresses.aWETH[network], { from: creator, chainId });
  // console.log("done.");
