...
module.exports = async function(deployer, network, accounts) {
  ...
  if (addresses.idleAaveV2RAI === undefined) {
    console.log("************************************************************************");
    console.log("set the value of idleAaveV2RAI from the previous migration and try again.");
    console.log("************************************************************************");
    return;
  }
  ...
  // add aRAI and its wrapper
  protocolTokens = [...protocolTokens, addresses.aRAI[network]];
  wrappers = [...wrappers, addresses.idleAaveV2RAI];
