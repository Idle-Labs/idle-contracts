...
module.exports = async (deployer, network, accounts) => {
  ...
  const result1 = await factory.create(implementation.address, initSig, initData1);
  ...
  const result2 = await factory.create(implementation.address, initSig, initData2);
