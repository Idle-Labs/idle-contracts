...
module.exports = async function(deployer, network, accounts) {
  ...
  // const aUSDCV2Wrapper = await idleToken.protocolWrappers(addresses.aUSDCV2[network]);
  // console.log("calling setAllAvailableTokensAndWrappers...");
  // console.log("aUSDCV2Wrapper:", aUSDCV2Wrapper)
  // await idleToken.setAllAvailableTokensAndWrappers(
  //   [addresses.aUSDCV2[network]], // protocolTokens
  //   [aUSDCV2Wrapper], // wrappers
  ...
  // await idleToken.setAToken(addresses.aUSDCV2[network], { from: creator, chainId });
  // console.log("done.");
